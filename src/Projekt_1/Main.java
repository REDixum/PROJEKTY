...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Osoba> osobaList = new ArrayList<>();
            osobaList.add(new Osoba("Jan", "Dudak", 3874, "ul.Farkor", LocalDate.parse("1999-11-23"), false));
            osobaList.add(new Osoba("Max", "Semczenko", 7823, "ul.Ukrainki", LocalDate.parse("1879-05-18"), true));  // najemca
            ...
            osobaList.add(new Osoba("Matwiej", "Noskow", 3480, "ul.Tankistow", LocalDate.parse("1967-12-10"), false));
            osobaList.add(new Osoba("Sasza", "Pupkin", 9754, "ul.Lorzkina", LocalDate.parse("2007-11-06"), true));  // najemca
